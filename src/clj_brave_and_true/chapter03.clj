...
;; Excersize 2: Write a function that takes a number and adds 100 to it.
(defn add100 [n] (+ 100 n))

;; Excersize 3: Write a function, dec-maker, that works 
;; exactly like the function inc-maker except with subtraction
(defn dec-maker [x] (fn [y] (- y x)))

;; Excersize 4: Write a function, mapset, that works like map
