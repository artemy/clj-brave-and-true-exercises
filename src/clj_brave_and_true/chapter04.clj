...
;; Excersize 1: Turn the result of your glitter filter into a list of names.
(defn glitter-filter-names
  [minimum-glitter records]
  (map :name (glitter-filter minimum-glitter records)))

;; Excersize 2: Write a function, append, which will append a new suspect to your list of suspects.
(defn append [map new-suspect]
  (conj map new-suspect))

;; Excersize 3: Write a function, validate, which will check that 
...
;; Excersize 4: Write a function that will take your list of maps
